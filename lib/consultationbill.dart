...
// class consultationbill extends StatefulWidget {
//   const consultationbill({Key? key}) : super(key: key);
...
class consultationbill extends StatefulWidget {
  ...
  @override
  State<consultationbill> createState() => consultationbillState();
}

class consultationbillState extends State<consultationbill> {
  GlobalKey<FormState> key = GlobalKey();

  List searchResult = [];

  Future<void> searchFromFirebase() async {
    final result = await FirebaseFirestore.instance.collection('consultationbill').get();
