...
class medicinebill extends StatefulWidget {
  ...
  @override
  State<medicinebill> createState() => medicinebillState();
}

class medicinebillState extends State<medicinebill> {
  GlobalKey<FormState> key = GlobalKey();

  List searchResult = [];

  Future<void> searchFromFirebase() async {
    final result = await FirebaseFirestore.instance.collection('medicinebill').get();
